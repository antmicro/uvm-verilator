...
function void m_rh_init(); endfunction : m_rh_init
  ...
  function int get_report_verbosity_level(uvm_severity severity=UVM_INFO, string id=""); endfunction
  ...
  function int get_report_max_verbosity_level(); endfunction
  ...
  function void set_report_verbosity_level (int verbosity_level); endfunction


  // @uvm-ieee 1800.2-2017 auto 6.3.4.4
  function void set_report_id_verbosity (string id, int verbosity); endfunction
  ...
  function void set_report_severity_id_verbosity (uvm_severity severity,
                                               string id, int verbosity); endfunction
  ...
  function int get_report_action(uvm_severity severity, string id); endfunction
  ...
  // @uvm-ieee 1800.2-2017 auto 6.3.5.2
  function void set_report_id_action (string id, uvm_action action); endfunction
  ...
  function void set_report_severity_id_action (uvm_severity severity,
                                               string id, uvm_action action); endfunction
  ...
  function int get_report_file_handle(uvm_severity severity, string id); endfunction


  // Function -- NODOCS -- set_report_default_file
  
  // @uvm-ieee 1800.2-2017 auto 6.3.6.2
  function void set_report_default_file (UVM_FILE file); endfunction

  // Function -- NODOCS -- set_report_id_file
  
  // @uvm-ieee 1800.2-2017 auto 6.3.6.2
  function void set_report_id_file (string id, UVM_FILE file); endfunction


  // @uvm-ieee 1800.2-2017 auto 6.3.6.2
  function void set_report_severity_file (uvm_severity severity, UVM_FILE file); endfunction
  ...
  function void set_report_handler(uvm_report_handler handler); endfunction
  ...
  function uvm_report_handler get_report_handler(); endfunction
  ...
  function void reset_report_handler; endfunction
